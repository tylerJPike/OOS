...
# chart forecasts
	...
	chart
```
Viewing our forecasts maks it apparent that the elastic net was a clear outlier, and it is no surprise it did not perform well in ex post analysis. We next turn to our forecast errors.
