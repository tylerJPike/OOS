...
2. provides sensible off-the-shelf defaults for new forecasters, while giving advanced users full control over all model and training function parameters for maximum flexibility
